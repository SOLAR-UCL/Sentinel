...
public class MutantsOperatorComparatorTest {
    ...
    public void compare() throws Exception {
        ...
        mutant1.getOperator().add(new Operator("Operator1", "Type1"));
        mutant1.getOperator().add(new Operator("Operator2", "Type2"));
        Mutant mutant2 = new Mutant("Mutant2", null, IntegrationFacade.getProgramUnderTest());
        mutant2.getOperator().add(new Operator("Operator2", "Type2"));
        mutant2.getOperator().add(new Operator("Operator3", "Type3"));
    ...
    public void compare2() throws Exception {
        ...
        mutant1.getOperator().add(new Operator("Operator2", "Type2"));
        Mutant mutant2 = new Mutant("Mutant2", null, IntegrationFacade.getProgramUnderTest());
        mutant2.getOperator().add(new Operator("Operator1", "Type2"));
        mutant2.getOperator().add(new Operator("Operator3", "Type4"));
        mutant2.getOperator().add(new Operator("Operator4", "Type3"));
        mutant2.getOperator().add(new Operator("Operator5", "Type3"));
        int result = comparator.compare(mutant1, mutant2);
