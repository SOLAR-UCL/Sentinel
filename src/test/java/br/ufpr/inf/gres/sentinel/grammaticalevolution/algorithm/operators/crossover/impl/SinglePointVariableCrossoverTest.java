...
public class SinglePointVariableCrossoverTest {
	...
	public static void setUp() throws Exception {
		operator = new SinglePointVariableCrossover<>(1.0);
		JMetalRandom.getInstance()
					.setRandomGenerator(new VariableLengthSolutionTest.PseudoRandomGeneratorStub(Iterators.cycle(2)));
	}
	...
	public void execute() throws Exception {
		...
		GrammaticalEvolutionAlgorithmTest.ProblemStub
				problemStub =
