 ...
 */
@Parameters(commandDescription = "If Sentinel must be executed for generating cache files.",
        commandNames = "cache")
public class CacheArgs {
    ...
    @Parameter(names = "--numberOfRuns",
            description = "Number of runs for each training program for creating the cache file.")
