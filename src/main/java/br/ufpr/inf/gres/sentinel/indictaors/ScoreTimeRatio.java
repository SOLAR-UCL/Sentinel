 ...
 * @param <S>
 */
public class ScoreTimeRatio<S extends Solution<?>> extends GenericIndicator<S> {
    ...
    public Double evaluate(List<S> solutionList) {
        return solutionList.stream()
                ...
                .mapToDouble(solution -> Math.abs(solution.getObjective(ScoreIndicator.SCORE_INDEX)) / solution.getObjective(TimeIndicator.TIME_INDEX))
                .average()
                .orElse(Double.NaN);
    }
